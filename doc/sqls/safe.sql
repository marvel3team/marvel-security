...
CREATE TABLE `t_company_base_info` (
  ...
  `industry_type` int(11) NOT NULL DEFAULT '-1' COMMENT '行业类型',
  `safety_level` int(11) NOT NULL DEFAULT '-1' COMMENT '安全等级',
  `certificate_start_time` bigint(20) NOT NULL DEFAULT '-1' COMMENT '安全证书发放日期',
  `certificate_end_time` bigint(20) NOT NULL DEFAULT '-1' COMMENT '安全证书到期日期',
